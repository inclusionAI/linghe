...
def test_softmax(M, N, benchmark):
...
def test_dot_sum(M, N, D, benchmark):
...
@pytest.mark.parametrize(
    "L,H,causal,hpc,safe,coef,clip_value",
    [
        (8192, 64, True, False, False, 1.0, None),
        (8192, 64, True, False, False, 1.0, 500.0),
        (8192, 64, True, True, False, 1.0, None),
        (8192, 64, True, False, True, 100.0, None),
        (4096, 64, True, False, False, 1.0, None),
        (4096, 64, False, False, False, 1.0, None),
        (8192, 64, False, False, False, 1.0, None),
        (8192, 1, False, False, False, 1.0, None),
    ],
)
def test_mla(L, H, causal, hpc, safe, coef, clip_value, benchmark, B=1):
...
@pytest.mark.parametrize(
    "LS,H,causal,hpc,safe,coef,clip_value,pad",
    [
        ([8192], 64, True, False, False, 1.0, None, False),
        ([8192], 64, True, False, True, 1.0, 100.0, False),
        ([8192], 64, True, False, True, 1.0, None, True),
        ([4096, 4096], 64, True, False, True, 1.0, None, False),
        ([2048, 2048, 4096], 64, True, True, True, 1.0, None, False),
        ([127, 873, 3096], 64, False, False, False, 1.0, None, False),
        ([127, 873, 3456], 16, False, False, True, 1.0, 100.0, False),
        ([127, 873, 3456], 16, False, False, True, 1.0, None, True),
        ([127, 873, 3456], 1, True, False, True, 1.0, None, False),
    ],
)
def test_varlen_mla(LS, H, causal, hpc, safe, coef, clip_value, pad, benchmark):
    dtype = torch.bfloat16
    device = "cuda:0"
    if pad:
...
@pytest.mark.parametrize(
    "B,L,H,causal,hpc,quant_value",
    [
        (1, 8192, 64, True, False, False),
    ],
)
def test_fp8_mla(B, L, H, causal, hpc, quant_value, benchmark):
    dtype = torch.bfloat16
    device = "cuda:0"
