...
if __name__ == '__main__':
    ...
    test_fp32_matmul(M=8192, N=256, K=4096, bench=True)
    ...
    test_fp32_matmul(M=64, N=157184, K=4096, bench=True)

    # blockwise gemm
    test_fp8_matmul(M=4, N=3072, K=4096, transpose_scale=True, bench=True)
    test_fp8_matmul(M=16, N=3072, K=4096, transpose_scale=True, bench=True)
    test_fp8_matmul(M=32, N=3072, K=4096, transpose_scale=True, bench=True)
    test_fp8_matmul(M=64, N=3072, K=4096, transpose_scale=True, bench=True)
    test_fp8_matmul(M=128, N=4096, K=4096, transpose_scale=True, bench=True)
    test_fp8_matmul(M=4096, N=4096, K=4096, transpose_scale=True, bench=True)
    test_fp8_matmul(M=4096, N=1024, K=4096, transpose_scale=False, bench=True)
