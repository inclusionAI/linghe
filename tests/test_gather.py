...
def test_batch_block_pad_permute_with_indices(
...
if __name__ == "__main__":
    ...
    test_batch_block_pad_permute_with_indices(
        M=8192 * 2, N=2048, n_experts=32, topk=2, bench=False
    )
    test_batch_block_pad_permute_with_indices(
        M=0, N=2048, n_experts=32, topk=2, bench=False
    )
    test_batch_block_pad_permute_with_indices(
        M=8192, N=1536, n_experts=32, topk=2, bench=False
    )
