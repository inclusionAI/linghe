...
def block_batch_weighted_silu_impl(input, weights, counts, splits, quantizers, grad_quantizers, cls, is_recomputing=None):
    assert input.ndim == 2
...
def mxfp8_batch_weighted_silu_impl(input, weights, counts, splits, quantizers, grad_quantizers, cls, is_recomputing=None):
    assert input.ndim == 2
