...
def padded_permute(
    ...
    permuted_input, permuted_probs, row_id_map = _PaddedPermute.apply(tokens, 
                                                                      probs, 
                                                                      routing_map, 
                                                                      tokens_per_expert_cuda_tensor, 
                                                                      tokens_per_expert_list)
...
def padded_unpermute(
    ...
    output = _PaddedUnpermute.apply(permuted_tokens, row_id_map, tokens_per_expert, restore_shape) 
    return output
...
def block_padded_permute(
    ...
    permuted_input, permuted_probs, row_id_map, row_id_index = _BlockPaddedPermute.apply(tokens, 
                                                                      probs, 
                                                                      routing_map, 
                                                                      tokens_per_expert_cuda_tensor, 
                                                                      tokens_per_expert_list,
