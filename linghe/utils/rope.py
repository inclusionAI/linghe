...
@triton.jit
def qk_norm_and_half_rope_backward_kernel(gq_ptr,
                                        gk_ptr,
                                        gv_ptr,
                                        qkv_ptr,
                                        q_norm_weight_ptr,
...
def triton_qk_norm_and_half_rope_backward(gq,
    ...
    qk_norm_and_half_rope_backward_kernel[grid](gq, gk, gv,
                                                            qkv,
...
@triton.jit
def varlen_qk_norm_and_half_rope_backward_kernel(gq_ptr, gk_ptr,
                                                            gv_ptr,
                                                            qkv_ptr,
                                                            q_norm_weight_ptr,
                                                            k_norm_weight_ptr,
