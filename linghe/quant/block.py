...
def batch_blockwise_quant_kernel(x_ptr,
    ...
    x = tl.load(x_ptr + si * N + rid * 128 * N + cid * 128 + tl.arange(0, 128)[:, None] * N + tl.arange(
    ...
    tl.store(xtq_ptr + si * N + rid * 128 + cid * 128 * count + tl.arange(0, 128)[:,None] * count + tl.arange(
