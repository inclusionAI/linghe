...
def triton_rms_norm_and_quant_forward(
    x, weight, smooth_scale, eps=1e-6, calibrate=False, round_scale=False, num_warps=4
):
    # row-wise read, row-wise write
    M, N = x.shape
...
if __name__ == "__main__":
    ...
    q, scale, maxs, rms = triton_rms_norm_and_quant_forward(
        x,
        weight,
